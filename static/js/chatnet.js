    ...
    `<div id="" class="recent-chat chat-item" data-user-id="` + obj.user_id + `" data-user-name="` + obj.user_name + `">
        <div class="user-list-item ">
            ...
            <div class="user-info">
                ...
                <div class="chat-preview">
                    <span class="chat-is-read">` + htmlDecode(last_msg) + `</span>
...
uppy.use(Uppy.XHRUpload, {
    ...
    getResponseData: function(responseText, response) {
        ...
        var upload_response = JSON.stringify(return_data.upload_data);
        if (upload_response != '[false]') {
            if(return_data.upload_data.length > 0){
                if(return_data.upload_as == "file"){
                    if ($('.reply-msg-row').hasClass('reply-msg-row-show')) {
                        var new_msg_data = {}
...
function load_default_panel(){
    ...
    var active_room = $("#active_room").val();
    if(active_user){
        $(".active-user-info").show("blind", {direction : adirection, easing: aexpo2}, 500);
    }else if(active_room){
        $(".active-group-info").show("blind", {direction : adirection, easing: aexpo2}, 500);
    }
}
...
function load_current_panel(panel){
    ...
    update_shown_panel();
    $(panel).show("blind", {direction : adirection, easing: aexpo2}, 500);
}
...
$( document ).ready(function() {
    ...
    $(".chat-list-toggle").on('click', function(e) {
        ...
        $(".panel-content").hide(300);
        $(".panel-content").show(100);

        if ($(window).width() <= 576) {

            $(".chat-list-col").toggleClass("col-3 col-12", 300, "easeOutExpo");
            ...
            if($(".logo img.small").is(":visible")){
                ...
                setTimeout(function(){ $(".logo img.small").show(); }, 300);
            ...
            $(".chat-list-col").toggleClass("mini-user-list", 300, "easeOutExpo");
        }
    ...
    $(".roomEmbed").on('shown.bs.popover', function(){
